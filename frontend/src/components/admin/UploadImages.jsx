...
const UploadImages = () => {
    ...
    files.forEach((file) => {
      ...
      reader.onload = () => {
        if (reader.readyState === 2) {
          setImagesPreview((oldImgArray) => [...oldImgArray, reader.result]);
          setImages((oldImgArray) => [...oldImgArray, reader.result]);
        }
      };
  ...
  // this function is to clear the uploaded images input
  ...
  // function to handle delete of choosen images before uploading to cloudinary
